    ...
    <div class="col-12 col-xl-6 col-lg-4 col-md-6">
        <div class="post-photo">
            ...
            <div class="actions-wrap">
                <div class="row">
                    <div class="col-4">
                        <div class="dislike-post margin-auto" onclick="add_sympathy(this)" data-action="skip" data-id="<?php echo $post['id'] ?>">
                    ...
                    <div class="col-4">
                        <div class="present-wrap margin-auto" onclick="get_presents(this)" data-user-id="<?php echo $post['id'] ?>">
                            <div class="present">
                    ...
                    <div class="col-4">
                        <div class="like-wrap margin-auto" onclick="add_sympathy(this)" data-action="like" data-id="<?php echo $post['id'] ?>">
                            <div class="like">
