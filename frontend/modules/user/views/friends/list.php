    ...
    <div class="col-12 col-xl-9 page-block friends-list">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-all-friends" role="tab" aria-controls="nav-home" aria-selected="true">Все друзья</a>
                    <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#nav-friends-request" role="tab" aria-controls="nav-home" aria-selected="true">Заявки в друзья</a>
                    ...
                    <?php foreach ($userFriendsRequest as $userFriendsRequestItem) : ?>
                        ...
                        <div class="friends_user_row clear_fix">
                            ...
                            <div class="friends_user_info">
                                ...
                                <a onclick="get_message_form(this)" data-user-id="<?php echo $userFriendsRequestItem['friendsProfiles']['id']?>" class="friends_field_act small-heading">Написать сообщение</a>
                            </div>
