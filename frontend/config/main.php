 ...
 //               'jpg' => 'jpeg',
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '<protocol>://<city:[a-z-0-9]+>.<domain>/user/setting/private' => 'user/edit/private',
                '<protocol>://<city:[a-z-0-9]+>.<domain>/user/login' => 'user/auth/login',
                '<protocol>://<city:[a-z-0-9]+>.<domain>/user/logout' => 'user/auth/logout',
                '<protocol>://<city:[a-z-0-9]+>.<domain>/user/balance' => 'user/pay/obmenka-pay', // 'user/user/balance',
                '<protocol>://<city:[a-z-0-9]+>.<domain>/user/balance/ob' => 'user/pay/obmenka-pay',
                ...
                '<protocol>://<city:[a-z-0-9]+>.<domain>/invitation/set-data' => 'invitation/set-data',
